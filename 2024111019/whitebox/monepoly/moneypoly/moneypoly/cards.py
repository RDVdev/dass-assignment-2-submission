...
CHANCE_CARDS = [
    ...
    {"description": "Collect $50 from every other player.",                  
     "action": "collect_from_all", "value": 50},
]

COMMUNITY_CHEST_CARDS = [
    {"description": "Bank error in your favour. Collect $200.",              
     "action": "collect",  "value": 200},
