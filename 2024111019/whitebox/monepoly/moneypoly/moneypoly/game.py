...
class Game:
    ...
    def _card_move_to(self, player, value):
        """Handle cards that move the player to an absolute board position."""
    ...
    def _card_collect_from_others(self, player, value):
        """Handle cards that collect money from each other player."""
